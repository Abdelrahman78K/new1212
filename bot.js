...
const prefix = "*"; // البرافيكس
   const GUILDID = '725364120475533418'; // اي دي السيرفر  
   const CHANNELID = '747404555158814720'; // اي دي الروم
//======================================[Client]======================================
// CODE BY KAHRBAA كههربا

client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("القران الكريم⚡",{type: 'WATCHING'})
});
// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://youtu.be/Jcl7MIRzvK0'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا
...
client.on('ready',async () => {
   ...
   function voiceStay(guildid, channelid) {
    if(!guildid) throw new Error('725364120475533418');
    if(!channelid) throw new Error('747404555158814720');
